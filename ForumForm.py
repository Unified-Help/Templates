...
class createForumPost(Form):
    ...
    category = SelectField('Category', [validators.DataRequired()], choices=[('', 'Select'), ('Unified Help Community', 'Unified Help Community'),('Announcements', 'Announcements'),('Pinned Posts', 'Pinned Posts')], default='')
